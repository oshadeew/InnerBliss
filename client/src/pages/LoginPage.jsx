...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-500 via-purple-500 to-pink-500 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-12">
          ...
          <h1 className="text-4xl font-bold mb-4">Inner Bliss</h1>
          <p className="text-lg text-white/80 leading-relaxed">Your personal sanctuary for mental wellness. Track your mood, practice breathing, and nurture your inner peace.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-violet-50 via-rose-50 to-sky-50">
        <div className="w-full max-w-md">
          ...
          <div className="glass-card p-8">
            ...
            <p className="text-gray-500 mb-6">Sign in to continue your wellness journey</p>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link to="/signup" className="text-primary-600 font-semibold hover:text-primary-700 transition-colors">Sign Up</Link>
            </p>
          </div>
        </div>
      </div>
